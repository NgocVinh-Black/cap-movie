...
//   layInfoGhe,
// } from "../../redux/slice/bookingSlice.js";
// import {
//   CheckOutlined,
//   CloseSquareOutlined,
//   DoubleLeftOutlined,
...
// import { layThongTinTaiKhoanApi } from "../../redux/slice/userSlice";
...
const BookTickets = (props) => {
  ...
  const { danhSachGheDangDat, rapPhim } = useSelector(
    (state) => state.QuanLyDatVeReducer
  );

  console.log("rapPhim in BookTickets:", rapPhim);
  if (!rapPhim) {
    // Handle the case where rapPhim is undefined (you can show a loading state or an error message)
    return <div>Loading...</div>;
  }
  // Make sure rapPhim has the expected structure
  if (!rapPhim.danhSachGhe || !rapPhim.thongTinPhim) {
    // Handle the case where danhSachGhe or thongTinPhim is undefined (you can show an error message)
              ...
              <div className="container ">
                ...
                >
                  ...
                  <div className="w-3/12 mr-7">
                    ...
                    <p className=" text-white my-3 ">
                      Địa Điểm :{" "}
                      <span className="text-red-600 my-2">{diaChi}</span>
                    </p>
                    <p className=" text-white ">
                      Ngày Chiếu :
                      <span className="text-red-600 my-2">{ngayChieu} </span>
                      ...
                      <div>
                        ...
                        {danhSachGheDangDat.map((gheDD, index) => {
                          return (
                            <span
                              key={index}
                              className="text-green-600 text-xl mx-1"
                            >
                              {gheDD.stt}
                            </span>
                          );
